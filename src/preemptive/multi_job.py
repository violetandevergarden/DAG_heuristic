"""Hierarchical single-channel scheduling for multiple preemptive DAG jobs.

This is a research module for the explicitly preemptive branch.  A multi-job
...
from preemptive.single_channel.solver import exact_oracle, residual_tail
