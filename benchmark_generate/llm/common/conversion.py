...
from benchmark_generate.llm.common.config import AICB_ROOT, SIMAI_ROOT, TOPOLOGIES, TOPO_ROOT
...
from benchmark_generate.llm.common.config import TOPOLOGY_CAPACITIES
